...
However, we see here what the issue with the anomalous-5 actually is. Vae4 is saying that the top horizontal line of the 5, has an abnormally long length (dimension 34). Vae4 is also saying that the lower tail has an abnormally small radius.(dimension 44).
